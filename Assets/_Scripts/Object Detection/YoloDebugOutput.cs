...
namespace Assets.Scripts
{
    ...
    public class YoloDebugOutput : MonoBehaviour
    {
        ...
        private readonly List<GameObject> lineRendererObjects = new List<GameObject>();
        ...
        internal void ShowDebugInformation(
            // TensorFloat inputTensor,
            List<YoloItem> detections, CameraTransform cameraPosition)
        {
