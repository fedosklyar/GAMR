...
namespace Assets.Scripts
{
    ...
    public static class Parameters
    {
        ...
        public static Vector2Int ModelImageResolution = new Vector2Int(640, 640);
        ...
        public static Vector2 VirtualProjectionPlane = new Vector2(VirtualProjectionPlaneWidth, (float)ModelImageResolution.y / ModelImageResolution.x);
